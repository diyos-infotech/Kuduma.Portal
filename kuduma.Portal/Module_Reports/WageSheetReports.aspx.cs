...
{
    public partial class Wagesheetreport : System.Web.UI.Page
    {
        ...
        protected void lbtn_Export_Click(object sender, EventArgs e)
        {
            try
            {
...

                {
                    ...
                    SPName = "EMPWAGESHEETREPORTFromTo";
                    options = ddloptions.SelectedIndex;
            ...
            // if (ddlclientid.SelectedIndex > 0)
            {
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        Label lblTotalcdRankAllowance = GVListEmployees.FooterRow.FindControl("lblTotalcdRankAllowance") as Label;
                        ...
                        Label lblTotalRankAllownace = GVListEmployees.FooterRow.FindControl("lblTotalRankAllownace") as Label;
                        ...
                        //1
                        Label lblTotalLeavewages = GVListEmployees.FooterRow.FindControl("lblTotalLeavewages") as Label;
                        ...
                        //2
                        Label lblTotalFixedLeavewages = GVListEmployees.FooterRow.FindControl("lblTotalFixedLeavewages") as Label;
                        ...
                        //3
                        Label lblTotalOTPerHour = GVListEmployees.FooterRow.FindControl("lblTotalOTPerHour") as Label;
                        ...
                        Label lblTotalIncentiveHrs = GVListEmployees.FooterRow.FindControl("lblTotalIncentiveHrs") as Label;
                        ...
                        Label lblTotalIncentiveAmt = GVListEmployees.FooterRow.FindControl("lblTotalIncentiveAmt") as Label;
                        ...
                        if (totalMobileusageDed > 0)
                        {
                            GVListEmployees.Columns[137].Visible = true;
                        }
                        else
                        {
                            GVListEmployees.Columns[137].Visible = false;
                        ...
                        if (totalMediClaimDed > 0)
                        {
                            GVListEmployees.Columns[138].Visible = true;
                        }
                        else
                        {
                        ...
                        Label lblTotalAdminChargesDed = GVListEmployees.FooterRow.FindControl("lblTotalAdminChargesDed") as Label;
                        ...
                        {
                            GVListEmployees.Columns[142].Visible = true;
                        }
                        else
                        {
                            GVListEmployees.Columns[142].Visible = false;
                        ...
                        if (totalBGVDed > 0)
                        {
                            GVListEmployees.Columns[143].Visible = true;
                        }
                        else
                        {
                            GVListEmployees.Columns[143].Visible = false;
                        ...
                        Label lblTotalAdvanceAgainstBonus = GVListEmployees.FooterRow.FindControl("lblTotalAdvanceAgainstBonus") as Label;
                        lblTotalAdvanceAgainstBonus.Text = Math.Round(totalAdvBonus).ToString();
                        if (totalAdvBonus > 0)
                        {
                            GVListEmployees.Columns[144].Visible = true;
                        }
                        else
                        {
                            GVListEmployees.Columns[144].Visible = false;
