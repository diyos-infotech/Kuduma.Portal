    ...
    public partial class WagesheetReportctc : System.Web.UI.Page
    {
        ...
        protected void lbtn_Export_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                float totalOTPerHour = 0;
                float totalfixedLeavewages = 0;
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        // if (dt.Rows[i]["Monthname"].ToString() == "Sub Total")
                        {
                            ...
                            if (actAmount >= 0)
                            {
                                ...
                                string strleavewages = dt.Rows[i]["Leavewages"].ToString();
                                if (strleavewages.Trim().Length > 0)
                                {
                                    totalLeavewages += Convert.ToSingle(strleavewages);

                                }

                                string strotperhour = dt.Rows[i]["OTPerHour"].ToString();
                                if (strotperhour.Trim().Length > 0)
                                {
                                    totalOTPerHour += Convert.ToSingle(strotperhour);

                                }

                                string strFixedLeavewages = dt.Rows[i]["FixedLeavewages"].ToString();
                                if (strFixedLeavewages.Trim().Length > 0)
                                {
                                    totalfixedLeavewages += Convert.ToSingle(strFixedLeavewages);
            ...
            // if (ddlclientid.SelectedIndex > 0)
            {
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (totalDuties > 0)
                        {
                            GVListEmployees1.Columns[9].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[9].Visible = false;
                        ...
                        if (totalNPCl25Per > 0)
                        {
                            GVListEmployees1.Columns[10].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[10].Visible = false;

                        }
                        //Label lbltotalESIDays = GVListEmployees.FooterRow.FindControl("lbltotalESIDays") as Label;
                        //lbltotalESIDays.Text = Math.Round(totalstrESIDays).ToString();
                        //if (totalstrESIDays > 0)
                        //{
                        ...
                        if (totalCdBasic > 0)
                        {
                            GVListEmployees1.Columns[12].Visible = true;

                        }
                        else
                        {
                            GVListEmployees1.Columns[12].Visible = false;
                        ...
                        if (totalCdDA > 0)
                        {
                            GVListEmployees1.Columns[13].Visible = true;

                        }
                        else
                        {
                            GVListEmployees1.Columns[13].Visible = false;
                        ...
                        if (totalCdHRA > 0)
                        {
                            GVListEmployees1.Columns[14].Visible = true;

                        }
                        else
                        {
                            GVListEmployees1.Columns[14].Visible = false;
                        ...
                        if (totalCdCCA > 0)
                        {
                            GVListEmployees1.Columns[15].Visible = true;

                        }
                        else
                        {
                            GVListEmployees1.Columns[15].Visible = false;
                        ...
                        if (totalCdConveyance > 0)
                        {
                            GVListEmployees1.Columns[16].Visible = true;

                        }
                        else
                        {
                            GVListEmployees1.Columns[16].Visible = false;
                        ...
                        if (totalCdWA > 0)
                        {
                            GVListEmployees1.Columns[17].Visible = true;

                        }
                        else
                        {
                            GVListEmployees1.Columns[17].Visible = false;
                        ...
                        if (totalCdNfhs > 0)
                        {
                            GVListEmployees1.Columns[18].Visible = true;

                        }
                        else
                        {
                            GVListEmployees1.Columns[18].Visible = false;
                        ...
                        if (totalnpots > 0)
                        {
                            GVListEmployees1.Columns[55].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[55].Visible = false;
                        ...
                        if (totalIncentivs > 0)
                        {
                            GVListEmployees1.Columns[76].Visible = true;

                        }
                        else
                        {
                            GVListEmployees1.Columns[76].Visible = false;
                        ...
                        //1
                        Label lblTotalLeavewages = GVListEmployees1.FooterRow.FindControl("lblTotalLeavewages") as Label;
                        lblTotalLeavewages.Text = Math.Round(totalLeavewages).ToString();
                        ...
                        //2
                        Label lblTotalFixedLeavewages = GVListEmployees1.FooterRow.FindControl("lblTotalFixedLeavewages") as Label;
                        lblTotalFixedLeavewages.Text = Math.Round(totalfixedLeavewages).ToString();
                        ...
                        //3
                        Label lblTotalOTPerHour = GVListEmployees1.FooterRow.FindControl("lblTotalOTPerHour") as Label;
                        lblTotalOTPerHour.Text = Math.Round(totalOTPerHour).ToString();
                        ...
                        if (totalpfempr > 0)
                        {
                            GVListEmployees1.Columns[138].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[138].Visible = false;
                        ...
                        if (totalotesi > 0)
                        {
                            GVListEmployees1.Columns[140].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[140].Visible = false;
                        ...
                        if (totalgstper > 0)
                        {
                            GVListEmployees1.Columns[144].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[144].Visible = false;
                        ...
                        if (totalgrandtotal > 0)
                        {
                            GVListEmployees1.Columns[145].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[145].Visible = false;
                        ...
                        if (totalAdvances > 0)
                        {
                            GVListEmployees1.Columns[146].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[146].Visible = false;
                        ...
                        if (totalUnifom > 0)
                        {
                            GVListEmployees1.Columns[147].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[147].Visible = false;
                        ...
                        if (totalOthers > 0)
                        {
                            GVListEmployees1.Columns[148].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[148].Visible = false;
                        ...
                        if (totalTotDeductions > 0)
                        {
                            GVListEmployees1.Columns[149].Visible = true;
                        }
                        else
                        {
                            GVListEmployees1.Columns[149].Visible = false;
        ...
        protected void lbtn_ExportNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    string filename = "WageSheetALL.xls";
