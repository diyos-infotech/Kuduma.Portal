<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="WagesheetReportctc.aspx.cs" Inherits="Kuduma.Portal.Module_Reports.WagesheetReportctc" %>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="WageSheetReports.aspx" style="z-index: 7;" class="active_bread">Wage Sheet Report</a></li>
                </ul>
            </div>
                        ...
                        <div class="boxbody" style="padding: 5px 5px 5px 5px;">
                            <div class="boxin">
                                ...
                                <div id="forExport" class="rounded_corners" style="overflow: scroll" runat="server">
                                    <asp:GridView ID="GVListEmployees1" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <asp:TemplateField HeaderText="Sal. Rate">
                                            ...
                                            <%-- 5--%>
                                            <asp:TemplateField HeaderText="UAN">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbluanno" runat="server" Text='<%# Eval("UANNo") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <%-- 10--%>
                                            <asp:TemplateField HeaderText="OT Hours" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOTHours" runat="server" Text='<%#Bind("OTHrs") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <%-- 11--%>
                                            <asp:TemplateField HeaderText="ESI Days" ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblESIDays" runat="server" Text='<%#Bind("Empty") %>'></asp:Label>
                                                </ItemTemplate>
                                               <%-- <FooterTemplate>
                                                    <asp:Label runat="server" ID="lbltotalESIDays"></asp:Label>
                                                </FooterTemplate>--%>
                                                 <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            ...
                                            <%-- 38--%>
                                            <asp:TemplateField HeaderText="Fixed Rank Allowance" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblcdRankAllowance" runat="server" Text='<%#Bind("CdRankAllowance","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalcdRankAllowance"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                         ...
                                         <%--  <asp:TemplateField HeaderText="GWR" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <%-- 94--%>
                                            <asp:TemplateField HeaderText="Rank Allowance" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRankAllowance" runat="server" Text='<%#Bind("RankAllowance","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalRankAllownace"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <%-- 98--%>
                                            <asp:TemplateField HeaderText="Total Gross" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Admin Charges Ded" ItemStyle-HorizontalAlign="Center">
                                                ...
                                                <FooterTemplate>
                                                    <div style="text-align: justify">
                                                        <asp:Label runat="server" ID="lblTotalAdminChargesDed"></asp:Label>
                                                    </div>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Advance Against Bonus" ItemStyle-HorizontalAlign="Center">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalAdvanceAgainstBonus"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Net Pay" ItemStyle-HorizontalAlign="Center">
                                             ...
                                             <%-- 134--%>
                                            <asp:TemplateField HeaderText="OT EARNED" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                             ...
                                             <%-- 135--%>
                                            <asp:TemplateField HeaderText="OT ESI Deduction" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOTESIDeduction" runat="server" Text='<%#Bind("otesi","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalOTESIDeduction"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <%-- 136--%>
                                            <asp:TemplateField HeaderText="NET OT" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNETOT" runat="server" Text='<%#Bind("netot","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalNETOT"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <%-- 137--%>
                                            <asp:TemplateField HeaderText="TOTAL NET PAY" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTOTALNETPAY" runat="server" Text='<%#Bind("ActualAmount","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalTOTALNETPAY"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <%-- 138--%>
                                            <asp:TemplateField HeaderText="PF @13%" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                            ...
                                            <%-- 139--%>
                                            <asp:TemplateField HeaderText="ESI @3.25%" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                            ...
                                            <%-- 140--%>
                                            <asp:TemplateField HeaderText="ESI ON OT" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblESIONOT" runat="server" Text='<%#Bind("otesi","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalESIONOT"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <%-- 141--%>
                                            <asp:TemplateField HeaderText="Uniform Charges" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblUniformCharges" runat="server" Text='<%#Bind("uniformcharge","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalUniformCharges"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <%-- 143--%>
                                            <asp:TemplateField HeaderText="SERV CHRG @5%" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSERVCHRG" runat="server" Text='<%#Bind("servicecharge","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalSERVCHRG"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                            <%-- 144--%>
                                            <asp:TemplateField HeaderText="GST 18%" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblGST" runat="server" Text='<%#Bind("gstper","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalGST"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="GRAND TOTAL" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblGRANDTOTAL" runat="server" Text='<%#Bind("grandtotal","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Advances" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAdvances" runat="server" Text='<%#Bind("Advances","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalAdvances"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>

                                             <%-- 147--%>
                                            <asp:TemplateField HeaderText="Unifom" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblUnifom" runat="server" Text='<%#Bind("Unifom","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalUnifom"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Others" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOthers" runat="server" Text='<%#Bind("Others","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalOthers"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Total Deductions" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTotalDeductions" runat="server" Text='<%#Bind("TotDeductions","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Net Pay" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNetPayy" runat="server" Text='<%#Bind("ActualAmount","{0:0}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <asp:Label runat="server" ID="lblTotalNetPayy"></asp:Label>
                                                </FooterTemplate>
                                            </asp:TemplateField>
