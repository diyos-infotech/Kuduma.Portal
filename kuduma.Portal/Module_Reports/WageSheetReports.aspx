<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="Wagesheetreports.aspx.cs" Inherits="Kuduma.Portal.Module_Reports.Wagesheetreport" %>
                                ...
                                <div id="forExport" class="rounded_corners" style="overflow: scroll" runat="server">
                                    <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%" CssClass="table table-striped table-bordered table-condensed table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <%-- 113--%>
                                            <asp:TemplateField HeaderText="Uniform Ded" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Rent Ded" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTransportDed" runat="server" Text='<%#Bind("RentDed","{0:0}") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: justify">
                                            ...
                                            <asp:TemplateField HeaderText="BGV Ded" ItemStyle-HorizontalAlign="Center">
                                                ...
                                                <FooterTemplate>
                                                    <div style="text-align: justify">
                                                        <asp:Label runat="server" ID="lblTotalBGVDed"></asp:Label>
                                                    </div>
                                                </FooterTemplate>
                                            </asp:TemplateField>
