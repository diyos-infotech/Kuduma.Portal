    ...
    public partial class ApproveEmployee : System.Web.UI.Page
    {
        ...
        protected void ModifyEmpdetails(string Empid)//Modify   personal Save button  
        {
            ...
            try
            {
                ...
                //pnlphysicalGDX2.Enabled = false;
                //pnlphysicalGDX.Enabled = false;
        ...
        protected void LoadPersonalInfo(string empid)
        {
            try
            {
                ...
                chkreliever.Checked=Convert.ToBoolean(dt.Rows[0]["Employeetype"].ToString());
        ...
        protected void Btnedit_Click(object sender, EventArgs e)
        {
            ...
            //pnlphysicalGDX2.Enabled = true;
            //pnlphysicalGDX.Enabled = true;
