<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MainMaster.master"  CodeBehind="POPrint.aspx.cs" Inherits="Kuduma.Portal.POPrint" %>
                            ...
                            <div class="boxinc">
                                ...
                                <table cellpadding="5" cellspacing="5" width="50%">
                                    <tr>
                                        <td>PO No</td>
                                        <td>
                                            <asp:DropDownList ID="ddlPONo" runat="server" CssClass="ddlautocomplete chosen-select" TabIndex="2" Style="width: 100px">
