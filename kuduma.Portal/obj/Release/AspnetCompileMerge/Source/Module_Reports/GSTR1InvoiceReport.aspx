<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="GSTR1InvoiceReport.aspx.cs" Inherits="Kuduma.Portal.Module_Reports.GSTR1InvoiceReport" %>
                                ...
                                <div id="forExport" style="overflow: scroll; width: 960px;" runat="server">
                                    <asp:GridView ID="GVInvoiceBills" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <%-- 3--%>
                                            <asp:TemplateField HeaderText="Customer Billing Name" ItemStyle-Width="125px">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblClientName" Text='<%# Bind("clientname") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%-- 4--%>
                                            <asp:TemplateField HeaderText="Customer Billing GSTIN">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblCustomerbilling" Text='<%# Bind("GSTIN") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%-- 5--%>
                                            <asp:TemplateField HeaderText="State Place of Supply">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblState" Text='<%# Bind("State") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%-- 6--%>
                                            <asp:TemplateField HeaderText="Service Description" ItemStyle-Width="125px">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblservice" Text='<%# Bind("ServiceDescription") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%-- 7--%>
                                            <asp:TemplateField HeaderText="HSN or SAC code" ItemStyle-Width="125px">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblHsno" Text=""></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%-- 8--%>
                                            <asp:TemplateField HeaderText="Total Item Discount Amount" ItemStyle-Width="125px">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblTida" Text='<%# Bind("TotalItemDiscountAmount") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right">
                                                        <asp:Label runat="server" ID="lblTotalTDAValue"></asp:Label>
                                                    </div>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <%-- 9--%>
                                            <asp:TemplateField HeaderText="Item Taxable Value" ItemStyle-Width="125px">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblTaxable" Text='<%# Bind("ItemTaxableValue") %>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right">
                                            ...
                                            <asp:TemplateField HeaderText="Grand Total" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblGRAND" runat="server" Text='<%#Bind("Totalvalue","{0:0.00}") %>'> </asp:Label>
                                                </ItemTemplate>
                                                <FooterTemplate>
                                                    <div style="text-align: right">
