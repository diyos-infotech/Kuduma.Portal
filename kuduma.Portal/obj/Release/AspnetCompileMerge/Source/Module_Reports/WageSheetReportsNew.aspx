<%@ Page Title="" Language="C#" MasterPageFile="~/Module_Reports/ReportMaster.master" AutoEventWireup="true" CodeBehind="WagesheetreportsNew.aspx.cs" Inherits="Kuduma.Portal.Module_Reports.WagesheetreportNew" %>
                                ...
                                <div class="dashboard_firsthalf" style="width: 100%">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    ...
                                                    &nbsp;
                                                    <asp:LinkButton ID="lbtn_PdfExport" runat="server" OnClick="btndownloadpdf_Click">Download PDF</asp:LinkButton>

                                                     &nbsp;
                                                    <asp:LinkButton ID="lbtn_ExportNew" runat="server" OnClick="lbtn_ExportNew_Click">Export to Excel All</asp:LinkButton>
                                                </td>
                                    ...
                                    <table width="100%" cellpadding="5" cellspacing="5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlBranch" runat="server" AutoPostBack="false" Width="150px" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged"
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtmonth" runat="server" Text="" CssClass="form-control" Width="150px" AutoComplete="off" AutoPostBack="true" OnTextChanged="txtmonth_TextChanged"></asp:TextBox>
                                            ...
                                            <td>
                                                 <asp:Button runat="server" ID="Button1" Text="Submit" class="btn save" OnClick="btn_Submit_Click" />
                                            </td>
