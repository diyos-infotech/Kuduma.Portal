<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MainMaster.master" CodeBehind="ESIBranches.aspx.cs" Inherits="Kuduma.Portal.ESIBranches" %>
                            ...
                            <div class="boxin">
                                <div class="dashboard_firsthalf" style="width: 100%">
                                 <table width="100%">
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblEsibranch" runat="server" Text="ESI Branch :" class="fontstyle"></asp:Label><span style="color: Red">*</span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtesino" runat="server" class="sinput"></asp:TextBox>
                                        ...
                                        <asp:GridView ID="gvEsibranches" runat="server" AutoGenerateColumns="false" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="ESI Branch" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                                                 ...
                                                 <asp:TemplateField HeaderText="ESI NO" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-Width="70%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblEsibranchname" runat="server" Text='<%#Bind("ESINO") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtESINO" runat="server" Text='<%#Bind("ESINO") %>' Width="500px"></asp:TextBox>
                                                    </EditItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="OPERATIONS" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <EditItemTemplate>
                                                        ...
                                                        <asp:LinkButton ID="linkcancel" runat="server"  Visible="false" CommandName="cancel" Text="Cancel"
