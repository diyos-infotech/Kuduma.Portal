<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyClient.aspx.cs" MasterPageFile="~/Module_Clients/Clients.master" Inherits="Kuduma.Portal.ModifyClient" %>
                            ...
                            <div class="dashboard_firsthalf" style="width: 100%">
                                <table width="100%" cellpadding="5" cellspacing="5">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                                <td>
                                                    <asp:Label ID="lblUnitIncharge" runat="server" Text="Unit Incharge"></asp:Label>

                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="ddlUnitIncharge" runat="server" class="sdrop"></asp:DropDownList>
                                                </td>
                                            </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlBranch" Enabled="true" runat="server" TabIndex="30"
                                                class="sdrop">
                                            </asp:DropDownList>
                                            &nbsp;</td>
                                    </tr>
                                        ...
                                        <td valign="top" align="right">
                                            <table width="100%" cellpadding="5" cellspacing="5">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList runat="server" ID="ddlUnits" OnSelectedIndexChanged="ddlUnits_SelectedIndexChanged" AutoPostBack="true"  TabIndex="21" class="sdrop" Visible="false">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
